	...
	if ($result->num_rows > 0) 
	  {
	  	 ...
	  	 { 
	  	 	...
	  	 	$return.=  $linha["client_activate"] . "|" . $linha["client_data_nascimento"] . "|" . $linha["client_data_ultimo_atend"]. "|" . $linha["client_cep"] . "|" . $linha["client_bairro"] . "|".  $linha["client_address"] . "|" .  $linha["client_indicacao"] . "|" .  $linha["client_profissao"] . "|" .  $linha["client_cidade"] . "|" .  $linha["client_sexo"] . "|" ;
