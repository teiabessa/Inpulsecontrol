...
<div id="frmagenda">
	...
	Tipo de Agendamento<select class="frmclient" name="agenda_type" id="agenda_type" onchange="addPacote('tratamento')" >
	     <?php
	     //	<select class="frmclient" name="client_seq" id="client_seq" onchange="this.form.submit()">
			...
			$strfield= 'Data: <input class="frmclient" type="date" name="agenda_date" id="agenda_date" size="30" ';
			...
			$stroption.= '<select class="frmclient" name="agenda_concluded" id="agenda_concluded" >';
			...
			if ($agenda_concluded == "2")
			   $stroption.='selected';
			$stroption.='>Cancelou</option>';
			   
			$stroption.='<option value= "3"';
			if ($agenda_concluded == "3")
			   	$stroption.='selected';
			$stroption.='>Concluído</option>';
			...
			$stroption.= '<select class="frmclientside" name="agenda_type_pagto" id="agenda_type_pagto" >';
			...
			$strfield= 'Dados do Cheque: <input class="frmclient" type="text" name="agenda_cheque" id="agenda_cheque" size="40"';
			$strfield.= 'value="'.$agenda_cheque .'">';
			echo $strfield;
			   
			$strfield='<input type="hidden" id="agenda_seq" name="agenda_seq" ';
			$strfield.= 'value='.$agenda_seq.'>';
