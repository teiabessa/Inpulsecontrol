			...
			if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file))
			 {
				...
				$sql2= 'insert into client_pictures (clipi_client_seq, clipi_filetype) values ('.$_POST["client_seq"] . ',  ".' . $imageFileType . '" )';
				...
				$destination.="<script>location.href='". $path_inpulsecontrol. "/dsp_form_client_list.php?client_seq=". $_POST["client_seq"] . "'</script>";
				echo $destination;
