...
{	
	...
	{
		$return.= $linha["secl_prof_seq"]. "|" . $linha["secl_valor_vendido"] . "|" . $linha["secl_qtd_sessao_realizada"] . "|" . $linha["secl_contrato_seq"]. "|". $linha["agenda_date"]. "|" .$linha["time_start"] . "|" .$linha["time_end"]. "|". $linha["secl_agenda_type_pagto"]. "|" . $linha["secl_agenda_cheque"]. "|"  . $linha["secl_agenda_sala"].   "|". $linha["secl_days_weak"]. "|" ;
