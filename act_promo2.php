...
$sql = "SELECT client_name, client_email  from client where client_seq in (1211)";
//echo $sql;
...
if ($result->num_rows > 0)
{
	while ($linha = $result->fetch_assoc())
	{
		...
		$message .=' <p>acesse o link para obter mais informações desta técnica:  <a href="http://inpulsebrasil.com.br/index.php?menu_seq=0&tratamento=along_cilios">Inpulsebrasil.com.br</a> </p>';
		$message .= '<img src="http://inpulsebrasil.com.br/inpulsecontrol/images/along_cilios.jpg" border="0"">';
		$message .= '</td> </tr>';
		$message .= '<tr> <td> <p>';
		$message .= 'Continuamos com essa promoção abaixo até o fim de agosto. Aberta aos pais, avôs, avós, mãe e filhos(as).. </p>';
		$message .= '<img src="http://inpulsebrasil.com.br/inpulsecontrol/images/dia_pais.jpg" width= "600" height="500"  border="0"">';
		$message .= '</td> </tr>';
		$message .= '<tr> <td> <p>obs.: Pagamento em dinheiro ou no débito! </p>';
		$message .= '</td> </tr>';
