...
if ($_POST["client_seq"] == "")
{
	...
	$sql= "INSERT INTO client (client_name, client_cpf, client_rg, client_address, client_cep, client_email,  client_data_nascimento, client_bairro) ";
    ...
    for($x = 0; $x < $arrlength; $x++) 
      ...
      // invoca a página que envia email de boas vindas ao cliente
