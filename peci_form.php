...
// verifica se a variável secl_seq foi definida
...
if ($secl_forma_venda == "0")
	$stroption.='selected';
$stroption.='>'. utf8_encode("Renovação"). '</option>';
...
if ($secl_forma_venda == "2")
	$stroption.='selected';
$stroption.='>'. utf8_encode("Convênio"). '</option>';

$stroption.='<option value= "3"';
if ($secl_forma_venda == "3")
	$stroption.='selected';
$stroption.='>'. utf8_encode("Captação Externa"). '</option>';
...
$strfield='Quantidade de '. utf8_encode('Sessões'). ' Realizadas:<input class="frmclient" type="number" name="secl_qtd_sessao_realizada" id="secl_qtd_sessao_realizada" size="15" value="'.$secl_qtd_sessao_realizada .'">';
echo $strfield;
...
$strfield= 'Parcelamento('. utf8_encode('Crédito ou Cheque'). '):<input class="frmclient" min="1" type="number" name="secl_parcelas" id="secl_parcelas" size="5"';
